...
| metal            | macos             | prove, std | Deprecated - release-3.0 does not enable Metal GPU acceleration by default on Apple Silicon; local proving falls back to CPU in this release line.         | risc0-circuit-recursion, risc0-circuit-rv32im, risc0-zkp, risc0-zkvm |
