...
/// Hash the given bytes, returning the digest and a [Receipt] that can be used
/// to verify that the that the hash was computed correctly (i.e. that the
/// Prover knows a preimage for the given SHA-256 hash)
///
