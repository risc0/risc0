...
// The version check is run inside a build script so we can't simple call `println!`
...
pub fn build_example() {
    ...
    #[cfg(not(feature = "prove"))]
    {
            ...
            && client_version != server_version
        {
            ...
            println_build!("       installation of RISC Zero. The cargo command you ran to build or run this example");
