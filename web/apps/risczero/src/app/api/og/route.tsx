...
export async function GET(request: Request) {
  ...
  const imageData = searchParams.has("bonsai")
    ? await fetch(new URL("./og-bonsai.png", import.meta.url)).then((res) => res.arrayBuffer())
    : searchParams.has("steel")
      ? await fetch(new URL("./og-steel.png", import.meta.url)).then((res) => res.arrayBuffer())
      : searchParams.has("zeth")
        ? await fetch(new URL("./og-zeth.png", import.meta.url)).then((res) => res.arrayBuffer())
        : searchParams.has("blobstream-zero")
          ? await fetch(new URL("./og-blobstream-zero.png", import.meta.url)).then((res) => res.arrayBuffer())
          : await fetch(new URL("./og.png", import.meta.url)).then((res) => res.arrayBuffer());
