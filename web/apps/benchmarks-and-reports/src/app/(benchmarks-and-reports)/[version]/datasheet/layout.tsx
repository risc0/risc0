			...
			<div className="flex items-center justify-between gap-8">
				<div>
					...
					<p className="text-muted-foreground text-sm">
						The data on this page can be used to estimate the total time and
						work required for proving zkVM applications. We recommend reading
						about our{" "}
						<Link
					...
					<div className="text-muted-foreground text-sm">
						<Popover>
							...
							<PopoverContent className="w-full max-w-screen-sm text-sm">
								...
								<br />
								<p>
									The last two steps are only required if you'd like to verify
									your proofs on-chain. The row labelled{" "}
									<CodeBadge>succinct</CodeBadge> shows the cost for{" "}
									<CodeBadge>execute</CodeBadge> + <CodeBadge>rv32im</CodeBadge>{" "}
									+ <CodeBadge>lift</CodeBadge>. The row labelled{" "}
									<CodeBadge>groth16</CodeBadge> shows the cost for{" "}
									<CodeBadge>execute</CodeBadge> + <CodeBadge>rv32im</CodeBadge>{" "}
									+ <CodeBadge>lift</CodeBadge> +{" "}
									<CodeBadge>identity_p254</CodeBadge> +
									<CodeBadge>stark2snark</CodeBadge>.
									<br />
									<br />
									On Bonsai, calls to <CodeBadge>rv32im</CodeBadge>,{" "}
									<CodeBadge>lift</CodeBadge>, and <CodeBadge>join</CodeBadge>{" "}
									are parallellized.
								</p>
							</PopoverContent>
						</Popover>
