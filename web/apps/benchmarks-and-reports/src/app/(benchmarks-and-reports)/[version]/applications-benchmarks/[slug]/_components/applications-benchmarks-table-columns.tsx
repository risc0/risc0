...
const columnHelper = {
	"release-0.21":
		createColumnHelper<ApplicationsBenchmarksTableSchema<"release-0.21">>(),
...
export const applicationsBenchmarksTableColumns = {
	"release-0.21": [
		columnHelper["release-0.21"].accessor("job_name", {
			header: ({ column }) => (
				<TableColumnHeader column={column} title="Job Name" />
			),
			cell: (info) => (
		...
		columnHelper["release-0.21"].accessor("job_size", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Job Size" />
			),
			cell: (info) => (
		...
		columnHelper["release-0.21"].accessor("insn_cycles", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="INSN Cycles" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatNumber(info.getValue())}
		...
		columnHelper["release-0.21"].accessor("prove_cycles", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Prove Cycles" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatNumber(info.getValue())}
		...
		columnHelper["release-0.21"].accessor("proof_bytes", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Proof Bytes" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatBytes(Number(info.getValue()))}
				</div>
			),
		}),
	...
	main: [
		...
		columnHelper.main.accessor("size", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Size" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatNumber(info.getValue())}
		...
		columnHelper.main.accessor("speed", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Speed" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
		...
		columnHelper.main.accessor("user_cycles", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="User Cycles" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatNumber(info.getValue())}
		...
		columnHelper.main.accessor("total_cycles", {
			header: ({ column }) => (
				<TableColumnHeader align="right" column={column} title="Total Cycles" />
			),
			cell: (info) => (
				<div className="truncate text-right font-mono">
					{formatNumber(info.getValue())}
	...
	] as ColumnDef<ApplicationsBenchmarksTableSchema<"release-3.0">, unknown>[],
};
