...
export const applicationsBenchmarksTableColumns = {
  "release-0.21": [
    columnHelper["release-0.21"].accessor("job_name", {
      ...
      cell: (info) => <div className="font-mono truncate">{info.getValue()}</div>,
    }),
    columnHelper["release-0.21"].accessor("job_size", {
      header: ({ column }) => <TableColumnHeader align="right" column={column} title="Job Size" />,
      cell: (info) => <div className="text-right font-mono truncate">{formatNumber(info.getValue())}</div>,
    }),
    columnHelper["release-0.21"].accessor("exec_duration", {
      ...
      cell: (info) => <div className="text-right font-mono truncate">{formatDuration(Number(info.getValue()))}</div>,
    }),
    ...
    columnHelper["release-0.21"].accessor("proof_bytes", {
      ...
      cell: (info) => <div className="text-right font-mono truncate">{formatBytes(Number(info.getValue()))}</div>,
    }),
  ...
  main: [
    ...
    columnHelper.main.accessor("speed", {
      ...
      cell: (info) => <div className="text-right font-mono truncate">{formatNumber(Number(info.getValue()))}</div>,
    }),
