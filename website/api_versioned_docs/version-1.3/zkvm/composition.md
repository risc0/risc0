...
[`add_assumption()`]: https://github.com/risc0/risc0/blob/release-1.3/examples/composition/src/main.rs#L29
[`env::verify()`]: https://github.com/risc0/risc0/blob/release-1.3/examples/composition/methods/guest/src/main.rs#L24
[`Prover::prove_with_opts`]: https://docs.rs/risc0-zkvm/1.3/risc0_zkvm/trait.Prover.html#method.prove_with_opts
[assumptions]: /terminology#assumption
[blog post]: https://www.risczero.com/blog/proof-composition
[code example]: https://github.com/risc0/risc0/tree/release-1.3/examples/composition#readme
...
[ReceiptClaim]: https://docs.rs/risc0-zkvm/1.3/risc0_zkvm/struct.ReceiptClaim.html
