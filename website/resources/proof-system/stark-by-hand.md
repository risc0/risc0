...
> When the RISC Zero [zkVM](/zkvm/zkvm_overview) executes, it generates a [receipt](https://docs.rs/risc0-zkvm/*/risc0_zkvm/struct.Receipt.html) that allows third-parties to authenticate the validity of the execution.
