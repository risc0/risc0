...
> The receipt contains a [zk-STARK] in the form of the [seal].
...
If you make sense of these 12 lessons, you'll have a solid handle on the mechanics of a zk-STARK (and we'd likely love to [hire you][job listing]).
...
> This lesson explains the mechanics of [Reed-Solomon encoding].
...
This [finite fields primer] covers just enough to make sense of RISC Zero's use of finite fields._
...
Each of these sets is "evenly spaced" throughout $\mathbb{F}_{97}$, which facilitates the use of [number theoretic transforms].

> Put succinctly, running an iNTT on a `trace column` gives the coefficients of a `trace polynomial`.

![Lesson 4a: iNTT of Trace Columns forms Trace Polynomials]
...
![Lesson 4b: Coefficients of Trace Polynomials]
...
![Lesson 4c: Evaluating Trace Polynomials]
...
> This lesson briefly describes how [arithmetization] is accomplished in RISC Zero.
...
>
> The [FRI protocol] provides a mechanism for the Verifier to confirm the low-degree-ness of polynomials, with very little computation required of the Verifier.
...
> For a more thorough security analysis, see our [ZKP Whitepaper] and the [Summary on the FRI Low-Degree Test].
...
[seal]: https://docs.rs/risc0-zkvm/*/risc0_zkvm/struct.SegmentReceipt.html#structfield.seal
...
[job listing]: https://jobs.ashbyhq.com/RiscZero
...
[Reed-Solomon encoding]: ../reference-docs/about-rs-codes.md
[finite fields primer]: ../reference-docs/about-finite-fields.md
[number theoretic transforms]: ../reference-docs/about-ntts-and-fourier.md
...
[FRI protocol]: ../reference-docs/about-fri.md
...
[Summary on the FRI Low-Degree Test]: https://eprint.iacr.org/2022/1216
