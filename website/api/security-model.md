...
Soundness is often quantified in terms of "[bits]" — using default parameters, our system currently targets 98 bits of security.
When adjusting system parameters such as segment size, we recommend running the [security calculator] to check the security level. 
