...
To utilize the results generated by a [zkVM](../../glossary.md#zkvm) program in your on-chain application, it's essential to [verify][term-verify] the [receipt][term-receipt] on-chain.
