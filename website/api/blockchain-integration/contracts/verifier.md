...
You can verify a RISC Zero [compact receipt][term-compact-receipt] using a `verify()` call to the [`RiscZeroVerifierRouter` contract][RiscZeroVerifierRouter@v0.10].
...
By using `RiscZeroVerifierRouter`, you opt in to RISC Zero's [Version Management Design][VersionManagement@main].
...
[term-compact-receipt]: /terminology#compact-receipt
