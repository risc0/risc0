...
#undef SIZES
pub const RISC0_FP4S : usize = NUM_FP4S;
pub const RISC0_CONS : usize = NUM_CONS;

lazy_static !{
  pub static ref RISC0_POLY_OPS : Vec<PolyOp> = vec ![
#define CHECK_EVAL
#define do_const(ov, vv) PolyOp::Const{out : ov, val : Fp::from(vv as u32)},
#define do_get(ov, x, y, z, iv) PolyOp::Get{out : ov, idx : iv},
#define do_get_global(ov, iv) PolyOp::GetGlobal{out : ov, idx : iv},
