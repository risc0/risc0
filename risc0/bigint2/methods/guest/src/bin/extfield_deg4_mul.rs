...
fn main() {
    ...
    let (lhs_0, lhs_1, lhs_2, lhs_3, rhs_0, rhs_1, rhs_2, rhs_3,
         monicirr_0, monicirr_1, monicirr_2, monicirr_3, prime):
        (BigUint, BigUint, BigUint, BigUint, BigUint, BigUint,
         BigUint, BigUint, BigUint, BigUint, BigUint, BigUint,
         BigUint) = env::read();
    let lhs = [lhs_0.to_u32_array(), lhs_1.to_u32_array(),
               lhs_2.to_u32_array(), lhs_3.to_u32_array()];
    let rhs = [rhs_0.to_u32_array(), rhs_1.to_u32_array(),
               rhs_2.to_u32_array(), rhs_3.to_u32_array()];
    let monicirr = [monicirr_0.to_u32_array(), monicirr_1.to_u32_array(),
                    monicirr_2.to_u32_array(), monicirr_3.to_u32_array()];
