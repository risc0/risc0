...
void doMemcpyTest(uint32_t srcOffset, uint32_t destOffset, uint32_t size) {
  ...
  Prover prover("risc0/r0vm/cpp/guest/test/test_memcpy");
  ...
  Receipt receipt = prover.run();
  receipt.verify("risc0/r0vm/cpp/guest/test/test_memcpy");
...
INSTANTIATE_TEST_SUITE_P(All,
                         CoreTests,
                         testing::Values(TestParam{"cpp", "risc0/r0vm/cpp/guest/test/"},
                                         TestParam{"rust", "risc0/r0vm/rust/guest/"}),
