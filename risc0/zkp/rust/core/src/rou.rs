...
/// That is, this list satisfies ROU_FWD[i+1] ^ 2 = ROU_FWD[i] in the prime field F_2013265921,
/// which implies ROU_FWD[i] ^ (2 ^ i) = 1.
...
/// This list satisfies ROU_FWD[i] * ROU_REV[i] = 1 in the prime field F_2013265921.
