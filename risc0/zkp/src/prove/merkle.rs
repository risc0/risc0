...
mod tests {
    ...
    fn verify_v3_merkle_proof() {
        ...
        let queries = 1;
        let transcript = [
            1045758241, 880664301, 1143822575, 1800428573, 140483729, 439836824, 1480414631,
            1326679616, 456340114, 416909705, 937094966, 1967772560, 242936774, 1781320569,
            613980098, 1227141953, 77225110, 302845272, 675167549, 1122574467, 1743323040,
            301964734, 567702744, 144550658, 151645491, 1599833721, 1602709730, 32451407,
            108288590, 382788382, 473749000, 1734211524, 1761073491,
        ];
