...
uint csoffset = mySignalStart+2637;
uint aux_dimensions[1] = {165};
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[293]); // line circom 330
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 3];
// load src
Fr_sub(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 335
...
Fr_lt(&expaux[0],&lvar[8],&circuitConstants[382]); // line circom 342
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[5];
// load src
