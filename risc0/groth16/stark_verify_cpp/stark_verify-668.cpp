...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[1]); // line circom 9
...
{
Fr_sub(&expaux[2],&circuitConstants[1],&signalValues[mySignalStart + 0]); // line circom 11
Fr_mul(&expaux[1],&signalValues[mySignalStart + 0],&expaux[2]); // line circom 11
{{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_sub(&expaux[1],&lvar[1],&signalValues[mySignalStart + 0]); // line circom 12
