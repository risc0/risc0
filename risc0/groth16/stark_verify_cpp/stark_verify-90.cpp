...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 3],&circuitConstants[243]); // line circom 283
// end load src
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&circuitConstants[244]); // line circom 285
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 5],&circuitConstants[245]); // line circom 286
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
