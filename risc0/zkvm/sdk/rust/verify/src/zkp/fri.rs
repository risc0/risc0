...
/// VerifyRoundInfo contains the data against which the queries for a particular round are checked. This includes the Merkle tree top row data, as well as the size of the domain of the polynomial, and the mixing parameter.
