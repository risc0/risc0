...
Fp step_verify_bytes(void* ctx, HostBridge host, size_t steps, size_t cycle, Fp** args) {
  ...
  if (x5 != 0) {
    ...
    // loc("Top/BytesHeader/BytesPlonkElement/Reg"("./cirgen/compiler/edsl/component.h":154:27))
  ...
  if (x10 != 0) {
    ...
    // loc("Top/mux(Mux)/bytes_fini(BytesFiniStep)/PlonkFini/BytesPlonkElement/Reg"("./cirgen/compiler/edsl/component.h":154:27))
