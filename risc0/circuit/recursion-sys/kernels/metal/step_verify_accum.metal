...
kernel void step_verify_accum(
    device void* ctx, const device uint32_t& steps, const device uint32_t& cycle, device Fp* arg0, device Fp* arg1, device Fp* arg2, device Fp* arg3, device Fp* arg4) {
