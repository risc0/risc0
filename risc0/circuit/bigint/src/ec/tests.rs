...
bigint_tests! {
    ec_add_test_8(
        ...
        ["00", "26", "01", "70", "69", "44"],
        [
            "01", "0100", "a3a3", "3f3f", "4a", "4b00", "e2e2", "3f3f", "2000", "69",
            "8900", "44", "2222", "2020", "c3c3", "3f3f", "22", "22",
        ],
        ["01", "b3"],
        [1189656581, 1393023727, 530886251, 138200174]
    ),
    ...
    ec_add_test_8_reverse(
        ...
        [
            "b2", "b100", "a3a3",
            "3f3f", "4a", "4b00", "e2e2", "3f3f", "2000", "69", "8900",
            "44", "2222", "2020", "c3c3", "3f3f", "22", "22",
        ],
        ["01", "b3"],
        [1250489330, 524171001, 248419375, 1873572595]
    ),
    ec_sub_test_8(
        ec_sub_rz8test,
        [
        ...
        [
            "6e", "3300", "a3a3",
            "3f3f", "91", "4500", "0202", "4040", "7600", "37", "0101",
            "90", "2222", "2020",
            "10c3", "3f3f", "22",
            "22"
        ],
        ["01", "b3"],
        [739405529, 388251984, 574617816, 1676744199]
    ),
    ec_doub_test_8(
        ec_doub_rz8test,
        [
        ...
        ["37", "90", "97", "ac"],
        [
            "17", "742300", "406363", "5f5f5f", "22",
            "6201", "30e3", "9e9e", "0000", "0000", "0700",
            "97", "2222", "2020", "a000", "ac",
            "c3c3", "3f3f", "22", "22",
        ],
        ["01", "01", "b3"],
        [1483833390, 1146077609, 1751132186, 769335939]
    ),
    ec_neg_test_8(
        ec_neg_rz8test,
        [
        ...
        ["22", "42"],
        ["b3"],
        [874249502, 798558777, 424251042, 1996058602]
    ),
    ec_pts_eq_test_8(
        ec_pts_eq_rz8test,
        [
    ...
    ec_on_curve_test_8(
        ...
        ["72", "53"],
        ["4800", "6c", "e3e3", "1f1f", "d200", "00", "6363", "5f5f", "22"],
        ["0c", "01", "b3"],
        [290966196, 1236705380, 1033801578, 389275994]
    ),
}
