...
use risc0_zkvm_platform::syscall::{rsa::WIDTH_WORDS, sys_rsa};
...
pub unsafe extern "C" fn sys_rsa_and_prove(  // TODO: Better name
    recv_buf: *mut [u32; WIDTH_WORDS],  // TODO nicer constant
    in_base: *const [u32; WIDTH_WORDS],
    in_modulus: *const [u32; WIDTH_WORDS],
) {
    unsafe {
        sys_rsa(recv_buf, in_base, in_modulus);
    }
    let result = (&*recv_buf)
        .iter()
    ...
    // TODO: Test unwinding by putting an error in here
