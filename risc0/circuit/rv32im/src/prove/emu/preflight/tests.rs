...
fn basic() {
    ...
    assert_slice_eq(
        ...
        &[
            ...
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ac0), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ac4), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ac8), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5acc), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ad0), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ad4), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5ad8), 0x00000000),
            MemoryTransaction::new(5, ByteAddr(0x0d6b5adc), 0x00000000),
        ],
    );
