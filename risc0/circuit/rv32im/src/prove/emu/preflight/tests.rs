...
fn basic() {
    ...
    assert_slice_eq(
        ...
        &[
            ...
            // reset(1)
            MemoryTransaction::new(5630, ByteAddr(0x00004000), 0x1234b137),
            MemoryTransaction::new(5630, ByteAddr(0x00004004), 0xf387e1b7),
            MemoryTransaction::new(5630, ByteAddr(0x00004008), 0x003100b3),
            MemoryTransaction::new(5630, ByteAddr(0x0000400c), 0x000045b7),
            MemoryTransaction::new(5631, ByteAddr(0x00004010), 0x00000073),
            MemoryTransaction::new(5631, ByteAddr(0x00004014), 0x00000000),
            MemoryTransaction::new(5631, ByteAddr(0x00004018), 0x00000000),
            MemoryTransaction::new(5631, ByteAddr(0x0000401c), 0x00000000),
            // reset(2)
            MemoryTransaction::new(5632, ByteAddr(0x0d6b5ac0), 0x2ea10cf3),
            MemoryTransaction::new(5632, ByteAddr(0x0d6b5ac4), 0x41559d09),
            MemoryTransaction::new(5632, ByteAddr(0x0d6b5ac8), 0x032b0b9e),
            MemoryTransaction::new(5632, ByteAddr(0x0d6b5acc), 0xda56a7af),
            MemoryTransaction::new(5633, ByteAddr(0x0d6b5ad0), 0x7c9d8024),
            MemoryTransaction::new(5633, ByteAddr(0x0d6b5ad4), 0x9bfea1c1),
            MemoryTransaction::new(5633, ByteAddr(0x0d6b5ad8), 0xc37b44c3),
            MemoryTransaction::new(5633, ByteAddr(0x0d6b5adc), 0x554f49f5),
        ],
    );
...
fn system_split() {
    ...
    assert_eq!(segments.len(), 2);
    {
        ...
        assert_eq!(trace.body.cycles.len(), 5636);
