...
const CODE: &[u32] = &[
    ...
    0x02a50ad9, // %695 = add(%677, %694): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x02b40ae5, // %698 = add(%692, %697): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x02b70b99, // %743 = add(%695, %742): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
