...
const CODE: &[u32] = &[
    ...
    0x031d0ca1, // %809 = add(%797, %808): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03260cad, // %812 = add(%806, %811): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03290cb9, // %815 = add(%809, %814): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x032c0cdd, // %824 = add(%812, %823): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03380ce9, // %827 = add(%824, %826): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03350d19, // %839 = add(%821, %838): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
