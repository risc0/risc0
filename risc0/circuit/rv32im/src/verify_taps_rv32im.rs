...
const CODE: &[u32] = &[
    ...
    0x03290cd1, // %821 = add(%809, %820): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03320cdd, // %824 = add(%818, %823): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
    ...
    0x03350ce9, // %827 = add(%821, %826): loc("cirgen/compiler/passes/MakeVerifyTaps.cpp":146:0)
