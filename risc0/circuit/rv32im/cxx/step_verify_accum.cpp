...
Fp step_verify_accum(void* ctx, HostBridge host, size_t steps, size_t cycle, Fp** args) {
  ...
  if (x9 != 0) {
    // loc("cirgen/components/fpext.cpp":24:5)
    {
  ...
  if (x4 != 0) {
    // loc("Top/PlonkHeader/FpExtReg1/Reg"("./cirgen/components/plonk.h":205:23))
    auto x10 = args[3][0];
    // loc("Top/PlonkHeader/FpExtReg1/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x11 = args[3][1];
    // loc("Top/PlonkHeader/FpExtReg1/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x12 = args[3][2];
    // loc("Top/PlonkHeader/FpExtReg1/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x13 = args[3][3];
    // loc("Top/PlonkHeader/FpExtReg2/Reg"("./cirgen/components/plonk.h":205:23))
    auto x14 = args[3][4];
    // loc("Top/PlonkHeader/FpExtReg2/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x15 = args[3][5];
    // loc("Top/PlonkHeader/FpExtReg2/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x16 = args[3][6];
    // loc("Top/PlonkHeader/FpExtReg2/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x17 = args[3][7];
    ...
    // loc("./cirgen/components/plonk.h":205:23)
    auto x20 = x10 * x18;
    // loc("./cirgen/components/plonk.h":205:23)
    auto x21 = x11 * x18;
    // loc("./cirgen/components/plonk.h":205:23)
    ...
    // loc("./cirgen/components/plonk.h":205:23)
    auto x23 = x13 * x18;
    // loc("./cirgen/components/plonk.h":205:17)
    auto x24 = x20 + x3;
    // loc("./cirgen/components/plonk.h":205:23)
    auto x25 = x14 * x19;
    // loc("./cirgen/components/plonk.h":205:23)
    ...
    // loc("./cirgen/components/plonk.h":205:17)
    auto x47 = x38 + x43;
    // loc("./cirgen/components/plonk.h":207:16)
    auto x48 = x29 * x44;
    // loc("./cirgen/components/plonk.h":207:16)
    auto x49 = x30 * x47;
    // loc("./cirgen/components/plonk.h":207:16)
    ...
    auto x1301 = x1299 + x1300;
    {
      ...
      // loc("./cirgen/components/plonk.h":266:27)
      ...
      // loc("./cirgen/components/plonk.h":266:16)
  ...
  if (x5 != 0) {
    ...
    // loc("Top/PlonkHeader1/FpExtReg1/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2763 = args[3][8];
    // loc("Top/PlonkHeader1/FpExtReg1/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2764 = args[3][9];
    // loc("Top/PlonkHeader1/FpExtReg1/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2765 = args[3][10];
    // loc("Top/PlonkHeader1/FpExtReg1/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2766 = args[3][11];
    // loc("Top/PlonkHeader1/FpExtReg2/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2767 = args[3][12];
    // loc("Top/PlonkHeader1/FpExtReg2/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2768 = args[3][13];
    // loc("Top/PlonkHeader1/FpExtReg2/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2769 = args[3][14];
    // loc("Top/PlonkHeader1/FpExtReg2/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2770 = args[3][15];
    // loc("Top/PlonkHeader1/FpExtReg3/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2771 = args[3][16];
    // loc("Top/PlonkHeader1/FpExtReg3/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2772 = args[3][17];
    // loc("Top/PlonkHeader1/FpExtReg3/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2773 = args[3][18];
    // loc("Top/PlonkHeader1/FpExtReg3/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2774 = args[3][19];
    // loc("Top/PlonkHeader1/FpExtReg4/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2775 = args[3][20];
    // loc("Top/PlonkHeader1/FpExtReg4/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2776 = args[3][21];
    // loc("Top/PlonkHeader1/FpExtReg4/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2777 = args[3][22];
    // loc("Top/PlonkHeader1/FpExtReg4/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2778 = args[3][23];
    // loc("Top/PlonkHeader1/FpExtReg5/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2779 = args[3][24];
    // loc("Top/PlonkHeader1/FpExtReg5/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2780 = args[3][25];
    // loc("Top/PlonkHeader1/FpExtReg5/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2781 = args[3][26];
    // loc("Top/PlonkHeader1/FpExtReg5/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2782 = args[3][27];
    // loc("Top/PlonkHeader1/FpExtReg6/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2783 = args[3][28];
    // loc("Top/PlonkHeader1/FpExtReg6/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2784 = args[3][29];
    // loc("Top/PlonkHeader1/FpExtReg6/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2785 = args[3][30];
    // loc("Top/PlonkHeader1/FpExtReg6/Reg3"("./cirgen/components/plonk.h":205:23))
    auto x2786 = args[3][31];
    // loc("Top/PlonkHeader1/FpExtReg7/Reg"("./cirgen/components/plonk.h":205:23))
    auto x2787 = args[3][32];
    // loc("Top/PlonkHeader1/FpExtReg7/Reg1"("./cirgen/components/plonk.h":205:23))
    auto x2788 = args[3][33];
    // loc("Top/PlonkHeader1/FpExtReg7/Reg2"("./cirgen/components/plonk.h":205:23))
    auto x2789 = args[3][34];
    // loc("Top/PlonkHeader1/FpExtReg7/Reg3"("./cirgen/components/plonk.h":205:23))
  ...
  if (x7 != 0) {
    ...
    if (x5804 != 0) {
      ...
      // loc("Top/Mux/4/Mux/0/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x5984 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x5984 != Fp::invalid());
      // loc("Top/Mux/4/Mux/0/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x5985 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x5985 != Fp::invalid());
      // loc("Top/Mux/4/Mux/0/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x6238 != 0) {
      ...
      // loc("Top/Mux/4/Mux/1/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x6418 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x6418 != Fp::invalid());
      // loc("Top/Mux/4/Mux/1/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x6419 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x6419 != Fp::invalid());
      // loc("Top/Mux/4/Mux/1/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x6672 != 0) {
      ...
      // loc("Top/Mux/4/Mux/2/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x6852 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x6852 != Fp::invalid());
      // loc("Top/Mux/4/Mux/2/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x6853 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x6853 != Fp::invalid());
      // loc("Top/Mux/4/Mux/2/ComputeCycle/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x7106 != 0) {
      ...
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement7/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x7346 = args[2][156 * steps + ((cycle - 0) & mask)];
      assert(x7346 != Fp::invalid());
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement7/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x7347 = args[2][157 * steps + ((cycle - 0) & mask)];
      assert(x7347 != Fp::invalid());
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement7/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      ...
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement8/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x7406 = args[2][163 * steps + ((cycle - 0) & mask)];
      assert(x7406 != Fp::invalid());
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement8/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x7407 = args[2][164 * steps + ((cycle - 0) & mask)];
      assert(x7407 != Fp::invalid());
      // loc("Top/Mux/4/Mux/3/RamBody/PlonkBody/RamPlonkElement8/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x7759 != 0) {
      ...
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement7/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x7999 = args[2][156 * steps + ((cycle - 0) & mask)];
      assert(x7999 != Fp::invalid());
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement7/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x8000 = args[2][157 * steps + ((cycle - 0) & mask)];
      assert(x8000 != Fp::invalid());
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement7/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      ...
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement8/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x8059 = args[2][163 * steps + ((cycle - 0) & mask)];
      assert(x8059 != Fp::invalid());
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement8/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x8060 = args[2][164 * steps + ((cycle - 0) & mask)];
      assert(x8060 != Fp::invalid());
      // loc("Top/Mux/4/Mux/4/RamBody/PlonkBody/RamPlonkElement8/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x8412 != 0) {
      ...
      // loc("Top/Mux/4/Mux/5/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x8592 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x8592 != Fp::invalid());
      // loc("Top/Mux/4/Mux/5/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x8593 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x8593 != Fp::invalid());
      // loc("Top/Mux/4/Mux/5/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
    ...
    if (x8856 != 0) {
      ...
      // loc("Top/Mux/4/Mux/8/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9036 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x9036 != Fp::invalid());
      // loc("Top/Mux/4/Mux/8/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9037 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x9037 != Fp::invalid());
      // loc("Top/Mux/4/Mux/8/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9038 = args[2][151 * steps + ((cycle - 0) & mask)];
      ...
      auto x9039 = args[2][152 * steps + ((cycle - 0) & mask)];
      ...
      auto x9040 = args[2][153 * steps + ((cycle - 0) & mask)];
      ...
      auto x9041 = args[2][154 * steps + ((cycle - 0) & mask)];
      ...
      auto x9042 = args[2][155 * steps + ((cycle - 0) & mask)];
      ...
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9096 = args[2][2 * steps + ((cycle - 0) & mask)];
      assert(x9096 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9097 = args[2][3 * steps + ((cycle - 0) & mask)];
      assert(x9097 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9098 = args[2][4 * steps + ((cycle - 0) & mask)];
      assert(x9098 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9099 = args[2][5 * steps + ((cycle - 0) & mask)];
      assert(x9099 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9100 = args[2][6 * steps + ((cycle - 0) & mask)];
      assert(x9100 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9101 = args[2][7 * steps + ((cycle - 0) & mask)];
      assert(x9101 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg3"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9102 = args[2][8 * steps + ((cycle - 0) & mask)];
      ...
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9156 = x9092 * x9152;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9157 = x9093 * x9155;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9158 = x9094 * x9154;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9159 = x9157 + x9158;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9160 = x9095 * x9153;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9161 = x9159 + x9160;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9162 = x9161 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9163 = x9156 + x9162;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9164 = x9092 * x9153;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9165 = x9093 * x9152;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9166 = x9164 + x9165;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9167 = x9094 * x9155;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9168 = x9095 * x9154;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9169 = x9167 + x9168;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9170 = x9169 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9171 = x9166 + x9170;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9172 = x9092 * x9154;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9173 = x9093 * x9153;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9174 = x9172 + x9173;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9175 = x9094 * x9152;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9176 = x9174 + x9175;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9177 = x9095 * x9155;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9178 = x9177 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9179 = x9176 + x9178;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9180 = x9092 * x9155;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9181 = x9093 * x9154;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9182 = x9180 + x9181;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9183 = x9094 * x9153;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9184 = x9182 + x9183;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9185 = x9095 * x9152;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9186 = x9184 + x9185;
      {
        host(ctx, "plonkReadAccum", "ram", host_args.data(), 0, host_outs.data(), 4);
        auto x9187 = host_outs.at(0);
        auto x9188 = host_outs.at(1);
        auto x9189 = host_outs.at(2);
        auto x9190 = host_outs.at(3);
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][4 * steps + cycle];
        ...
        {
          auto& reg = args[4][6 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9189);
          reg = x9189;
        }
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][7 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9190);
          reg = x9190;
        }
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9191 = x9012 * x9012;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9192 = x9035 + x9035;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9193 = x9020 * x9192;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9194 = x9028 * x9028;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9195 = x9193 - x9194;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9196 = x9195 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9197 = x9191 + x9196;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9198 = x9028 + x9028;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9199 = x9012 * x9198;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9200 = x9020 * x9020;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9201 = x9199 - x9200;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9202 = x9035 * x9035;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9203 = x9202 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9204 = x9201 + x9203;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9205 = x9197 * x9197;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9206 = x9204 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9207 = x9206 * x9204;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9208 = x9205 + x9207;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9209 = inv(x9208);
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9210 = x9197 * x9209;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9211 = x9204 * x9209;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9212 = x9012 * x9210;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9213 = x9028 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9214 = x9213 * x9211;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9215 = x9212 + x9214;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9216 = -x9020;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9217 = x9216 * x9210;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9218 = x9035 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9219 = x9218 * x9211;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9220 = x9217 - x9219;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9221 = -x9012;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9222 = x9221 * x9211;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9223 = x9028 * x9210;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9224 = x9222 + x9223;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9225 = x9020 * x9211;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9226 = x9035 * x9210;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9227 = x9225 - x9226;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9228 = x9187 * x9215;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9229 = x9188 * x9227;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9230 = x9189 * x9224;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9231 = x9229 + x9230;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9232 = x9190 * x9220;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9233 = x9231 + x9232;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9234 = x9233 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9235 = x9228 + x9234;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9236 = x9187 * x9220;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9237 = x9188 * x9215;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9238 = x9236 + x9237;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9239 = x9189 * x9227;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9240 = x9190 * x9224;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9241 = x9239 + x9240;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9242 = x9241 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9243 = x9238 + x9242;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9244 = x9187 * x9224;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9245 = x9188 * x9220;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9246 = x9244 + x9245;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9247 = x9189 * x9215;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9248 = x9246 + x9247;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9249 = x9190 * x9227;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9250 = x9249 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9251 = x9248 + x9250;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9252 = x9187 * x9227;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9253 = x9188 * x9224;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9254 = x9252 + x9253;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9255 = x9189 * x9220;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9256 = x9254 + x9255;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9257 = x9190 * x9215;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9258 = x9256 + x9257;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9259 = x9235 * x9163;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9260 = x9243 * x9186;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9261 = x9251 * x9179;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9262 = x9260 + x9261;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9263 = x9258 * x9171;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9264 = x9262 + x9263;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9265 = x9264 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9266 = x9259 + x9265;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9267 = x9235 * x9171;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9268 = x9243 * x9163;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9269 = x9267 + x9268;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9270 = x9251 * x9186;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9271 = x9258 * x9179;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9272 = x9270 + x9271;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9273 = x9272 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9274 = x9269 + x9273;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9275 = x9235 * x9179;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9276 = x9243 * x9171;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9277 = x9275 + x9276;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9278 = x9251 * x9163;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9279 = x9277 + x9278;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9280 = x9258 * x9186;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9281 = x9280 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9282 = x9279 + x9281;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9283 = x9235 * x9186;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9284 = x9243 * x9179;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9285 = x9283 + x9284;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9286 = x9251 * x9171;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9287 = x9285 + x9286;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9288 = x9258 * x9163;
        // loc("./cirgen/components/plonk.h":266:16)
    ...
    // loc("cirgen/compiler/edsl/component.cpp":35:15)
    auto x9290 = args[2][103 * steps + ((cycle - 0) & mask)];
    assert(x9290 != Fp::invalid());
    if (x9290 != 0) {
      {
        host(ctx, "plonkReadAccum", "ram", host_args.data(), 0, host_outs.data(), 4);
        auto x9291 = host_outs.at(0);
        auto x9292 = host_outs.at(1);
        auto x9293 = host_outs.at(2);
        auto x9294 = host_outs.at(3);
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][4 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9291);
          reg = x9291;
        }
        // loc("cirgen/components/fpext.cpp":24:5)
        {
    ...
    // loc("cirgen/compiler/edsl/component.cpp":35:15)
    auto x9295 = args[2][104 * steps + ((cycle - 0) & mask)];
    assert(x9295 != Fp::invalid());
    if (x9295 != 0) {
      {
        host(ctx, "plonkReadAccum", "ram", host_args.data(), 0, host_outs.data(), 4);
        auto x9296 = host_outs.at(0);
        auto x9297 = host_outs.at(1);
        auto x9298 = host_outs.at(2);
        auto x9299 = host_outs.at(3);
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][4 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9296);
          reg = x9296;
        }
        // loc("cirgen/components/fpext.cpp":24:5)
        {
    ...
    // loc("cirgen/compiler/edsl/component.cpp":35:15)
    auto x9300 = args[2][105 * steps + ((cycle - 0) & mask)];
    assert(x9300 != Fp::invalid());
    if (x9300 != 0) {
      {
        host(ctx, "plonkReadAccum", "ram", host_args.data(), 0, host_outs.data(), 4);
        auto x9301 = host_outs.at(0);
        auto x9302 = host_outs.at(1);
        auto x9303 = host_outs.at(2);
        auto x9304 = host_outs.at(3);
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][4 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9301);
          reg = x9301;
        }
        // loc("cirgen/components/fpext.cpp":24:5)
        {
    ...
    // loc("cirgen/compiler/edsl/component.cpp":35:15)
    auto x9305 = args[2][106 * steps + ((cycle - 0) & mask)];
    ...
    if (x9305 != 0) {
      ...
      auto x9307 = args[3][9];
      // loc("Top/PlonkHeader1/FpExtReg1/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9308 = args[3][10];
      // loc("Top/PlonkHeader1/FpExtReg1/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9309 = args[3][11];
      // loc("Top/PlonkHeader1/FpExtReg2/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9310 = args[3][12];
      // loc("Top/PlonkHeader1/FpExtReg2/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9311 = args[3][13];
      // loc("Top/PlonkHeader1/FpExtReg2/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9312 = args[3][14];
      // loc("Top/PlonkHeader1/FpExtReg2/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9313 = args[3][15];
      // loc("Top/PlonkHeader1/FpExtReg3/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9314 = args[3][16];
      // loc("Top/PlonkHeader1/FpExtReg3/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9315 = args[3][17];
      // loc("Top/PlonkHeader1/FpExtReg3/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9316 = args[3][18];
      // loc("Top/PlonkHeader1/FpExtReg3/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9317 = args[3][19];
      // loc("Top/PlonkHeader1/FpExtReg4/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9318 = args[3][20];
      // loc("Top/PlonkHeader1/FpExtReg4/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9319 = args[3][21];
      // loc("Top/PlonkHeader1/FpExtReg4/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9320 = args[3][22];
      // loc("Top/PlonkHeader1/FpExtReg4/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9321 = args[3][23];
      // loc("Top/PlonkHeader1/FpExtReg5/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9322 = args[3][24];
      // loc("Top/PlonkHeader1/FpExtReg5/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9323 = args[3][25];
      // loc("Top/PlonkHeader1/FpExtReg5/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9324 = args[3][26];
      // loc("Top/PlonkHeader1/FpExtReg5/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9325 = args[3][27];
      // loc("Top/PlonkHeader1/FpExtReg6/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9326 = args[3][28];
      // loc("Top/PlonkHeader1/FpExtReg6/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9327 = args[3][29];
      // loc("Top/PlonkHeader1/FpExtReg6/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9328 = args[3][30];
      // loc("Top/PlonkHeader1/FpExtReg6/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9329 = args[3][31];
      // loc("Top/PlonkHeader1/FpExtReg7/Reg"("./cirgen/components/plonk.h":205:23))
      auto x9330 = args[3][32];
      // loc("Top/PlonkHeader1/FpExtReg7/Reg1"("./cirgen/components/plonk.h":205:23))
      auto x9331 = args[3][33];
      // loc("Top/PlonkHeader1/FpExtReg7/Reg2"("./cirgen/components/plonk.h":205:23))
      auto x9332 = args[3][34];
      // loc("Top/PlonkHeader1/FpExtReg7/Reg3"("./cirgen/components/plonk.h":205:23))
      auto x9333 = args[3][35];
      // loc("Top/Mux/4/Mux/12/RamBody/PlonkBody/RamPlonkElement2/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9334 = args[2][121 * steps + ((cycle - 0) & mask)];
      ...
      auto x9335 = args[2][122 * steps + ((cycle - 0) & mask)];
      ...
      auto x9336 = args[2][123 * steps + ((cycle - 0) & mask)];
      ...
      auto x9337 = args[2][124 * steps + ((cycle - 0) & mask)];
      ...
      auto x9338 = args[2][125 * steps + ((cycle - 0) & mask)];
      ...
      auto x9339 = args[2][126 * steps + ((cycle - 0) & mask)];
      ...
      auto x9340 = args[2][127 * steps + ((cycle - 0) & mask)];
      assert(x9340 != Fp::invalid());
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9341 = x9306 * x9334;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9342 = x9307 * x9334;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9343 = x9308 * x9334;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9344 = x9309 * x9334;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9345 = x9341 + x3;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9346 = x9310 * x9335;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9347 = x9311 * x9335;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9348 = x9312 * x9335;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9349 = x9313 * x9335;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9350 = x9345 + x9346;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9351 = x9342 + x9347;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9352 = x9343 + x9348;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9353 = x9344 + x9349;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9354 = x9314 * x9336;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9355 = x9315 * x9336;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9356 = x9316 * x9336;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9357 = x9317 * x9336;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9358 = x9350 + x9354;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9359 = x9351 + x9355;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9360 = x9352 + x9356;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9361 = x9353 + x9357;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9362 = x9318 * x9337;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9363 = x9319 * x9337;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9364 = x9320 * x9337;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9365 = x9321 * x9337;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9366 = x9358 + x9362;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9367 = x9359 + x9363;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9368 = x9360 + x9364;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9369 = x9361 + x9365;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9370 = x9322 * x9338;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9371 = x9323 * x9338;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9372 = x9324 * x9338;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9373 = x9325 * x9338;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9374 = x9366 + x9370;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9375 = x9367 + x9371;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9376 = x9368 + x9372;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9377 = x9369 + x9373;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9378 = x9326 * x9339;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9379 = x9327 * x9339;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9380 = x9328 * x9339;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9381 = x9329 * x9339;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9382 = x9374 + x9378;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9383 = x9375 + x9379;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9384 = x9376 + x9380;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9385 = x9377 + x9381;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9386 = x9330 * x9340;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9387 = x9331 * x9340;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9388 = x9332 * x9340;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9389 = x9333 * x9340;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9390 = x9382 + x9386;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9391 = x9383 + x9387;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9392 = x9384 + x9388;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9393 = x9385 + x9389;
      // loc("Top/Mux/4/Mux/12/RamBody/PlonkBody/RamPlonkElement3/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9394 = args[2][128 * steps + ((cycle - 0) & mask)];
      ...
      auto x9395 = args[2][129 * steps + ((cycle - 0) & mask)];
      ...
      auto x9396 = args[2][130 * steps + ((cycle - 0) & mask)];
      ...
      auto x9397 = args[2][131 * steps + ((cycle - 0) & mask)];
      ...
      auto x9398 = args[2][132 * steps + ((cycle - 0) & mask)];
      ...
      auto x9399 = args[2][133 * steps + ((cycle - 0) & mask)];
      ...
      auto x9400 = args[2][134 * steps + ((cycle - 0) & mask)];
      assert(x9400 != Fp::invalid());
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9401 = x9306 * x9394;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9402 = x9307 * x9394;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9403 = x9308 * x9394;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9404 = x9309 * x9394;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9405 = x9401 + x3;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9406 = x9310 * x9395;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9407 = x9311 * x9395;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9408 = x9312 * x9395;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9409 = x9313 * x9395;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9410 = x9405 + x9406;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9411 = x9402 + x9407;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9412 = x9403 + x9408;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9413 = x9404 + x9409;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9414 = x9314 * x9396;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9415 = x9315 * x9396;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9416 = x9316 * x9396;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9417 = x9317 * x9396;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9418 = x9410 + x9414;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9419 = x9411 + x9415;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9420 = x9412 + x9416;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9421 = x9413 + x9417;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9422 = x9318 * x9397;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9423 = x9319 * x9397;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9424 = x9320 * x9397;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9425 = x9321 * x9397;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9426 = x9418 + x9422;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9427 = x9419 + x9423;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9428 = x9420 + x9424;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9429 = x9421 + x9425;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9430 = x9322 * x9398;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9431 = x9323 * x9398;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9432 = x9324 * x9398;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9433 = x9325 * x9398;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9434 = x9426 + x9430;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9435 = x9427 + x9431;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9436 = x9428 + x9432;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9437 = x9429 + x9433;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9438 = x9326 * x9399;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9439 = x9327 * x9399;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9440 = x9328 * x9399;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9441 = x9329 * x9399;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9442 = x9434 + x9438;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9443 = x9435 + x9439;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9444 = x9436 + x9440;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9445 = x9437 + x9441;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9446 = x9330 * x9400;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9447 = x9331 * x9400;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9448 = x9332 * x9400;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9449 = x9333 * x9400;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9450 = x9442 + x9446;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9451 = x9443 + x9447;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9452 = x9444 + x9448;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9453 = x9445 + x9449;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9454 = x9390 * x9450;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9455 = x9391 * x9453;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9456 = x9392 * x9452;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9457 = x9455 + x9456;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9458 = x9393 * x9451;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9459 = x9457 + x9458;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9460 = x9459 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9461 = x9454 + x9460;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9462 = x9390 * x9451;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9463 = x9391 * x9450;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9464 = x9462 + x9463;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9465 = x9392 * x9453;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9466 = x9393 * x9452;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9467 = x9465 + x9466;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9468 = x9467 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9469 = x9464 + x9468;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9470 = x9390 * x9452;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9471 = x9391 * x9451;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9472 = x9470 + x9471;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9473 = x9392 * x9450;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9474 = x9472 + x9473;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9475 = x9393 * x9453;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9476 = x9475 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9477 = x9474 + x9476;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9478 = x9390 * x9453;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9479 = x9391 * x9452;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9480 = x9478 + x9479;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9481 = x9392 * x9451;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9482 = x9480 + x9481;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9483 = x9393 * x9450;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9484 = x9482 + x9483;
      // loc("Top/Mux/4/Mux/12/RamBody/PlonkBody/RamPlonkElement6/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9485 = args[2][149 * steps + ((cycle - 0) & mask)];
      assert(x9485 != Fp::invalid());
      // loc("Top/Mux/4/Mux/12/RamBody/PlonkBody/RamPlonkElement6/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9486 = args[2][150 * steps + ((cycle - 0) & mask)];
      assert(x9486 != Fp::invalid());
      // loc("Top/Mux/4/Mux/12/RamBody/PlonkBody/RamPlonkElement6/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9487 = args[2][151 * steps + ((cycle - 0) & mask)];
      ...
      auto x9488 = args[2][152 * steps + ((cycle - 0) & mask)];
      ...
      auto x9489 = args[2][153 * steps + ((cycle - 0) & mask)];
      ...
      auto x9490 = args[2][154 * steps + ((cycle - 0) & mask)];
      ...
      auto x9491 = args[2][155 * steps + ((cycle - 0) & mask)];
      assert(x9491 != Fp::invalid());
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9492 = x9306 * x9485;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9493 = x9307 * x9485;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9494 = x9308 * x9485;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9495 = x9309 * x9485;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9496 = x9492 + x3;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9497 = x9310 * x9486;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9498 = x9311 * x9486;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9499 = x9312 * x9486;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9500 = x9313 * x9486;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9501 = x9496 + x9497;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9502 = x9493 + x9498;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9503 = x9494 + x9499;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9504 = x9495 + x9500;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9505 = x9314 * x9487;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9506 = x9315 * x9487;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9507 = x9316 * x9487;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9508 = x9317 * x9487;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9509 = x9501 + x9505;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9510 = x9502 + x9506;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9511 = x9503 + x9507;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9512 = x9504 + x9508;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9513 = x9318 * x9488;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9514 = x9319 * x9488;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9515 = x9320 * x9488;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9516 = x9321 * x9488;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9517 = x9509 + x9513;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9518 = x9510 + x9514;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9519 = x9511 + x9515;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9520 = x9512 + x9516;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9521 = x9322 * x9489;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9522 = x9323 * x9489;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9523 = x9324 * x9489;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9524 = x9325 * x9489;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9525 = x9517 + x9521;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9526 = x9518 + x9522;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9527 = x9519 + x9523;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9528 = x9520 + x9524;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9529 = x9326 * x9490;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9530 = x9327 * x9490;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9531 = x9328 * x9490;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9532 = x9329 * x9490;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9533 = x9525 + x9529;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9534 = x9526 + x9530;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9535 = x9527 + x9531;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9536 = x9528 + x9532;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9537 = x9330 * x9491;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9538 = x9331 * x9491;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9539 = x9332 * x9491;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9540 = x9333 * x9491;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9541 = x9533 + x9537;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9542 = x9534 + x9538;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9543 = x9535 + x9539;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9544 = x9536 + x9540;
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9545 = args[2][2 * steps + ((cycle - 0) & mask)];
      assert(x9545 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9546 = args[2][3 * steps + ((cycle - 0) & mask)];
      assert(x9546 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9547 = args[2][4 * steps + ((cycle - 0) & mask)];
      assert(x9547 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9548 = args[2][5 * steps + ((cycle - 0) & mask)];
      assert(x9548 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg1"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9549 = args[2][6 * steps + ((cycle - 0) & mask)];
      assert(x9549 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg2"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9550 = args[2][7 * steps + ((cycle - 0) & mask)];
      assert(x9550 != Fp::invalid());
      // loc("Top/PlonkHeader1/RamPlonkElement/U32Reg/Reg3"("./cirgen/compiler/edsl/component.h":81:27))
      auto x9551 = args[2][8 * steps + ((cycle - 0) & mask)];
      assert(x9551 != Fp::invalid());
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9552 = x9306 * x9545;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9553 = x9307 * x9545;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9554 = x9308 * x9545;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9555 = x9309 * x9545;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9556 = x9552 + x3;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9557 = x9310 * x9546;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9558 = x9311 * x9546;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9559 = x9312 * x9546;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9560 = x9313 * x9546;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9561 = x9556 + x9557;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9562 = x9553 + x9558;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9563 = x9554 + x9559;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9564 = x9555 + x9560;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9565 = x9314 * x9547;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9566 = x9315 * x9547;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9567 = x9316 * x9547;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9568 = x9317 * x9547;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9569 = x9561 + x9565;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9570 = x9562 + x9566;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9571 = x9563 + x9567;
      // loc("./cirgen/components/plonk.h":205:17)
      auto x9572 = x9564 + x9568;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9573 = x9318 * x9548;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9574 = x9319 * x9548;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9575 = x9320 * x9548;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9576 = x9321 * x9548;
      // loc("./cirgen/components/plonk.h":205:17)
      ...
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9581 = x9322 * x9549;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9582 = x9323 * x9549;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9583 = x9324 * x9549;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9584 = x9325 * x9549;
      // loc("./cirgen/components/plonk.h":205:17)
      ...
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9589 = x9326 * x9550;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9590 = x9327 * x9550;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9591 = x9328 * x9550;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9592 = x9329 * x9550;
      // loc("./cirgen/components/plonk.h":205:17)
      ...
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9597 = x9330 * x9551;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9598 = x9331 * x9551;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9599 = x9332 * x9551;
      // loc("./cirgen/components/plonk.h":205:23)
      auto x9600 = x9333 * x9551;
      // loc("./cirgen/components/plonk.h":205:17)
      ...
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9605 = x9541 * x9601;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9606 = x9542 * x9604;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9607 = x9543 * x9603;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9608 = x9606 + x9607;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9609 = x9544 * x9602;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9610 = x9608 + x9609;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9611 = x9610 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9612 = x9605 + x9611;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9613 = x9541 * x9602;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9614 = x9542 * x9601;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9615 = x9613 + x9614;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9616 = x9543 * x9604;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9617 = x9544 * x9603;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9618 = x9616 + x9617;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9619 = x9618 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9620 = x9615 + x9619;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9621 = x9541 * x9603;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9622 = x9542 * x9602;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9623 = x9621 + x9622;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9624 = x9543 * x9601;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9625 = x9623 + x9624;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9626 = x9544 * x9604;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9627 = x9626 * x0;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9628 = x9625 + x9627;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9629 = x9541 * x9604;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9630 = x9542 * x9603;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9631 = x9629 + x9630;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9632 = x9543 * x9602;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9633 = x9631 + x9632;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9634 = x9544 * x9601;
      // loc("./cirgen/components/plonk.h":207:16)
      auto x9635 = x9633 + x9634;
      {
        host(ctx, "plonkReadAccum", "ram", host_args.data(), 0, host_outs.data(), 4);
        auto x9636 = host_outs.at(0);
        auto x9637 = host_outs.at(1);
        auto x9638 = host_outs.at(2);
        auto x9639 = host_outs.at(3);
        // loc("cirgen/components/fpext.cpp":24:5)
        {
          auto& reg = args[4][4 * steps + cycle];
        ...
        {
          auto& reg = args[4][5 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9637);
          reg = x9637;
        }
        // loc("cirgen/components/fpext.cpp":24:5)
        {
        ...
        {
          auto& reg = args[4][7 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9639);
          reg = x9639;
        }
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9640 = x9461 * x9461;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9641 = x9484 + x9484;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9642 = x9469 * x9641;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9643 = x9477 * x9477;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9644 = x9642 - x9643;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9645 = x9644 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9646 = x9640 + x9645;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9647 = x9477 + x9477;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9648 = x9461 * x9647;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9649 = x9469 * x9469;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9650 = x9648 - x9649;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9651 = x9484 * x9484;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9652 = x9651 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9653 = x9650 + x9652;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9654 = x9646 * x9646;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9655 = x9653 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9656 = x9655 * x9653;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9657 = x9654 + x9656;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9658 = inv(x9657);
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9659 = x9646 * x9658;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9660 = x9653 * x9658;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9661 = x9461 * x9659;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9662 = x9477 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9663 = x9662 * x9660;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9664 = x9661 + x9663;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9665 = -x9469;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9666 = x9665 * x9659;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9667 = x9484 * x1;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9668 = x9667 * x9660;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9669 = x9666 - x9668;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9670 = -x9461;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9671 = x9670 * x9660;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9672 = x9477 * x9659;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9673 = x9671 + x9672;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9674 = x9469 * x9660;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9675 = x9484 * x9659;
        // loc("./cirgen/components/plonk.h":266:27)
        auto x9676 = x9674 - x9675;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9677 = x9636 * x9664;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9678 = x9637 * x9676;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9679 = x9638 * x9673;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9680 = x9678 + x9679;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9681 = x9639 * x9669;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9682 = x9680 + x9681;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9683 = x9682 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9684 = x9677 + x9683;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9685 = x9636 * x9669;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9686 = x9637 * x9664;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9687 = x9685 + x9686;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9688 = x9638 * x9676;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9689 = x9639 * x9673;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9690 = x9688 + x9689;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9691 = x9690 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9692 = x9687 + x9691;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9693 = x9636 * x9673;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9694 = x9637 * x9669;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9695 = x9693 + x9694;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9696 = x9638 * x9664;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9697 = x9695 + x9696;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9698 = x9639 * x9676;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9699 = x9698 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9700 = x9697 + x9699;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9701 = x9636 * x9676;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9702 = x9637 * x9673;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9703 = x9701 + x9702;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9704 = x9638 * x9669;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9705 = x9703 + x9704;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9706 = x9639 * x9664;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9707 = x9705 + x9706;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9708 = x9684 * x9612;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9709 = x9692 * x9635;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9710 = x9700 * x9628;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9711 = x9709 + x9710;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9712 = x9707 * x9620;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9713 = x9711 + x9712;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9714 = x9713 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9715 = x9708 + x9714;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9716 = x9684 * x9620;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9717 = x9692 * x9612;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9718 = x9716 + x9717;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9719 = x9700 * x9635;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9720 = x9707 * x9628;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9721 = x9719 + x9720;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9722 = x9721 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9723 = x9718 + x9722;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9724 = x9684 * x9628;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9725 = x9692 * x9620;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9726 = x9724 + x9725;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9727 = x9700 * x9612;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9728 = x9726 + x9727;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9729 = x9707 * x9635;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9730 = x9729 * x0;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9731 = x9728 + x9730;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9732 = x9684 * x9635;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9733 = x9692 * x9628;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9734 = x9732 + x9733;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9735 = x9700 * x9620;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9736 = x9734 + x9735;
        // loc("./cirgen/components/plonk.h":266:16)
        auto x9737 = x9707 * x9612;
        // loc("./cirgen/components/plonk.h":266:16)
        ...
        {
          auto& reg = args[4][31 * steps + cycle];
          assert(reg == Fp::invalid() || reg == x9738);
          reg = x9738;
        }
      }
    }
  ...
  if (x8 != 0) {
    {
      host(ctx, "plonkReadAccum", "bytes", host_args.data(), 0, host_outs.data(), 4);
      auto x9739 = host_outs.at(0);
      auto x9740 = host_outs.at(1);
      auto x9741 = host_outs.at(2);
      auto x9742 = host_outs.at(3);
      // loc("cirgen/components/fpext.cpp":24:5)
      {
        auto& reg = args[4][0 * steps + cycle];
      ...
      {
        auto& reg = args[4][3 * steps + cycle];
        assert(reg == Fp::invalid() || reg == x9742);
        reg = x9742;
      }
    }
  }
