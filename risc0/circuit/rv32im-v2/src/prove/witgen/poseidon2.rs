...
const P2_STATE_SIZE: usize = std::mem::size_of::<Poseidon2State>() / WORD_SIZE - 1;
...
impl Poseidon2State {
    ...
    pub(crate) fn as_array(&self) -> [u32; P2_STATE_SIZE] {
        ...
        [
            ...
            self.count,
            self.mode,
            self.get_inner_word(0),
            self.get_inner_word(1),
            self.get_inner_word(2),
            self.get_inner_word(3),
            self.get_inner_word(4),
            self.get_inner_word(5),
            self.get_inner_word(6),
            self.get_inner_word(7),
            self.get_inner_word(8),
            self.get_inner_word(9),
            self.get_inner_word(10),
            self.get_inner_word(11),
            self.get_inner_word(12),
            self.get_inner_word(13),
            self.get_inner_word(14),
            self.get_inner_word(15),
            self.get_inner_word(16),
            self.get_inner_word(17),
            self.get_inner_word(18),
            self.get_inner_word(19),
            self.get_inner_word(20),
            self.get_inner_word(21),
            self.get_inner_word(22),
            self.get_inner_word(23),
            zcheck[0].into(),
            zcheck[1].into(),
            zcheck[2].into(),
            zcheck[3].into(),
