...
// DigestReg(zirgen/circuit/keccak2/top.zir:390)
...
// ShutdownCycle(zirgen/circuit/keccak2/top.zir:398)
...
void step_Top_41(ExecContext& ctx,MutableBuf arg0)   {
// TopState(zirgen/circuit/keccak2/top.zir:36)
...
Val x177 = ((x176 + (get(ctx,arg0, 638, 2) * Val(16384))) + (get(ctx,arg0, 639, 2) * Val(32768)));
...
Val x185 = ((x184 + (get(ctx,arg0, 670, 1) * Val(16384))) + (get(ctx,arg0, 671, 1) * Val(32768)));
...
// NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
set(ctx,arg0, 991, bitAnd(x187, Val(1)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:35)
set(ctx,arg0, 992, (bitAnd(x187, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:36)
set(ctx,arg0, 993, (bitAnd(x187, Val(4)) * Val(1509949441)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:37)
Val x188 = ((get(ctx,arg0, 993, 0) * Val(4)) + (get(ctx,arg0, 992, 0) * Val(2)));
Val x189 = (x188 + get(ctx,arg0, 991, 0));
...
Val x276 = ((x275 + (get(ctx,arg0, 654, 2) * Val(16384))) + (get(ctx,arg0, 655, 2) * Val(32768)));
...
Val x284 = ((x283 + (get(ctx,arg0, 686, 1) * Val(16384))) + (get(ctx,arg0, 687, 1) * Val(32768)));
// Add2(zirgen/circuit/keccak2/sha2.zir:30)
...
// NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
set(ctx,arg0, 994, bitAnd(x288, Val(1)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:35)
set(ctx,arg0, 995, (bitAnd(x288, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:36)
set(ctx,arg0, 996, (bitAnd(x288, Val(4)) * Val(1509949441)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:37)
Val x289 = ((get(ctx,arg0, 996, 0) * Val(4)) + (get(ctx,arg0, 995, 0) * Val(2)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:38)
Val x290 = (x287 - ((x289 + get(ctx,arg0, 994, 0)) * Val(65536)));
// NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
