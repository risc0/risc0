...
ExpandBEStruct exec_ExpandBE(ExecContext& ctx,Val2Array arg0, BoundLayout<ExpandBELayout> layout1)   {
// Div(<preamble>:15)
...
NondetBitRegStruct32Array x34 = map(Val32Array{Val(0), Val(1), Val(2), Val(3), Val(4), Val(5), Val(6), Val(7), Val(8), Val(9), Val(10), Val(11), Val(12), Val(13), Val(14), Val(15), Val(16), Val(17), Val(18), Val(19), Val(20), Val(21), Val(22), Val(23), Val(24), Val(25), Val(26), Val(27), Val(28), Val(29), Val(30), Val(31)}, LAYOUT_LOOKUP(layout1, _super), ([&](Val32Array::value_type x35, BoundLayout<NondetRegLayout32LayoutArray::value_type> x36) {
...
NondetBitRegStruct x39 = exec_NondetBitReg(ctx,DivStruct32Array{x2, DivStruct{
  ._super = x3}, DivStruct{
  ._super = x4}, DivStruct{
  ._super = x5}, DivStruct{
  ._super = x6}, DivStruct{
  ...
  ._super = x33}}[to_size_t(((x38 * Val(8)) + x37))]._super, x36);
return x39;
...
return ExpandBEStruct{
  ._super = x34};
}
DigestRegStruct exec_DigestReg(ExecContext& ctx,Val16Array arg0, BoundLayout<DigestRegLayout> layout1)   {
