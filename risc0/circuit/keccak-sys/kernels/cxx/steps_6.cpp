...
set(ctx,arg0, 957, bitAnd(x187, Val(1)));
// CarryExtract(zirgen/circuit/keccak/sha2.zir:36)
set(ctx,arg0, 958, (bitAnd(x187, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak/sha2.zir:37)
set(ctx,arg0, 959, (bitAnd(x187, Val(4)) * Val(1509949441)));
// builtin Add
// CarryExtract(zirgen/circuit/keccak/sha2.zir:38)
Val x188 = ((get(ctx,arg0, 959, 0) * Val(4)) + (get(ctx,arg0, 958, 0) * Val(2)));
Val x189 = (x188 + get(ctx,arg0, 957, 0));
// builtin Sub
...
// builtin NondetReg
// NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
set(ctx,arg0, 960, bitAnd(x288, Val(1)));
// CarryExtract(zirgen/circuit/keccak/sha2.zir:36)
set(ctx,arg0, 961, (bitAnd(x288, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak/sha2.zir:37)
set(ctx,arg0, 962, (bitAnd(x288, Val(4)) * Val(1509949441)));
// builtin Add
// CarryExtract(zirgen/circuit/keccak/sha2.zir:38)
Val x289 = ((get(ctx,arg0, 962, 0) * Val(4)) + (get(ctx,arg0, 961, 0) * Val(2)));
// builtin Sub
// CarryExtract(zirgen/circuit/keccak/sha2.zir:39)
