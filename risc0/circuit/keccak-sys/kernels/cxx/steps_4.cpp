...
Val x177 = ((x176 + (get(ctx,arg0, 542, 2) * Val(16384))) + (get(ctx,arg0, 543, 2) * Val(32768)));
...
Val x185 = ((x184 + (get(ctx,arg0, 574, 1) * Val(16384))) + (get(ctx,arg0, 575, 1) * Val(32768)));
...
set(ctx,arg0, 937, bitAnd(x187, Val(1)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:35)
set(ctx,arg0, 938, (bitAnd(x187, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:36)
set(ctx,arg0, 939, (bitAnd(x187, Val(4)) * Val(1509949441)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:37)
Val x188 = ((get(ctx,arg0, 939, 0) * Val(4)) + (get(ctx,arg0, 938, 0) * Val(2)));
Val x189 = (x188 + get(ctx,arg0, 937, 0));
...
Val x276 = ((x275 + (get(ctx,arg0, 558, 2) * Val(16384))) + (get(ctx,arg0, 559, 2) * Val(32768)));
...
Val x284 = ((x283 + (get(ctx,arg0, 590, 1) * Val(16384))) + (get(ctx,arg0, 591, 1) * Val(32768)));
// Add2(zirgen/circuit/keccak2/sha2.zir:30)
...
// NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
set(ctx,arg0, 940, bitAnd(x288, Val(1)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:35)
set(ctx,arg0, 941, (bitAnd(x288, Val(2)) * Val(1006632961)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:36)
set(ctx,arg0, 942, (bitAnd(x288, Val(4)) * Val(1509949441)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:37)
Val x289 = ((get(ctx,arg0, 942, 0) * Val(4)) + (get(ctx,arg0, 941, 0) * Val(2)));
// CarryExtract(zirgen/circuit/keccak2/sha2.zir:38)
Val x290 = (x287 - ((x289 + get(ctx,arg0, 940, 0)) * Val(65536)));
// NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
...
void step_Top_51(ExecContext& ctx,MutableBuf arg0)   {
// Pack(zirgen/circuit/keccak2/pack.zir:33)
// Pack32(zirgen/circuit/keccak2/sha2.zir:72)
...
// Pack(zirgen/circuit/keccak2/pack.zir:33)
// Pack32(zirgen/circuit/keccak2/sha2.zir:72)
// ShaNextBlockCycle(zirgen/circuit/keccak2/top.zir:256)
...
// ShaNextBlockCycle(zirgen/circuit/keccak2/top.zir:258)
...
// Reg(<preamble>:4)
// TopState(zirgen/circuit/keccak2/top.zir:36)
// ShaNextBlockCycle(zirgen/circuit/keccak2/top.zir:261)
