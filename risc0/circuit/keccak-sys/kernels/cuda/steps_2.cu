...
__device__ void step_Top_33(ExecContext& ctx, MutableBuf arg0) {
  ...
  Val x2426 =
      (((x2425 + get(ctx, arg0, 944, 0)) + get(ctx, arg0, 950, 0)) + get(ctx, arg0, 951, 0));
  Val x2427 =
      (((x2426 + get(ctx, arg0, 952, 0)) + get(ctx, arg0, 953, 0)) + get(ctx, arg0, 954, 0));
  Val x2428 =
      (((x2427 + get(ctx, arg0, 956, 0)) + get(ctx, arg0, 957, 0)) + get(ctx, arg0, 958, 0));
