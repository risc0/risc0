...
__device__ void step_Top_20(ExecContext& ctx, MutableBuf arg0) {
  // ControlState(zirgen/circuit/keccak/top.zir:403)
  // ShaNextBlock(zirgen/circuit/keccak/top.zir:441)
...
__device__ void step_Top_36(ExecContext& ctx, MutableBuf arg0) {
...
__device__ void step_Top_52(ExecContext& ctx, MutableBuf arg0) {
  // Reg(<preamble>:5)
  // TopState(zirgen/circuit/keccak/top.zir:36)
  // InitCycle(zirgen/circuit/keccak/top.zir:316)
  ...
  set(ctx, arg0, 916, Val(58983));
  set(ctx, arg0, 917, Val(27145));
  set(ctx, arg0, 918, Val(44677));
  set(ctx, arg0, 919, Val(47975));
  set(ctx, arg0, 920, Val(62322));
  set(ctx, arg0, 921, Val(15470));
  set(ctx, arg0, 922, Val(62778));
  set(ctx, arg0, 923, Val(42319));
  set(ctx, arg0, 924, Val(21119));
  set(ctx, arg0, 925, Val(20750));
  set(ctx, arg0, 926, Val(26764));
  set(ctx, arg0, 927, Val(39685));
  set(ctx, arg0, 928, Val(55723));
  set(ctx, arg0, 929, Val(8067));
