...
__device__ void step_Top_39(ExecContext& ctx, MutableBuf arg0) {
  ...
  Val x177 =
      ((x176 + (get(ctx, arg0, 606, 2) * Val(16384))) + (get(ctx, arg0, 607, 2) * Val(32768)));
  ...
  Val x185 =
      ((x184 + (get(ctx, arg0, 638, 1) * Val(16384))) + (get(ctx, arg0, 639, 1) * Val(32768)));
  ...
  Val x276 =
      ((x275 + (get(ctx, arg0, 622, 2) * Val(16384))) + (get(ctx, arg0, 623, 2) * Val(32768)));
  ...
  Val x284 =
      ((x283 + (get(ctx, arg0, 654, 1) * Val(16384))) + (get(ctx, arg0, 655, 1) * Val(32768)));
  // Add2(zirgen/circuit/keccak/sha2.zir:30)
