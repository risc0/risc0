...
__device__ void step_Top(ExecContext& ctx, MutableBuf data0, GlobalBuf global1) {
  ...
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 4, x9);
  Val x10 = isz((Val(5) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 5, x10);
  Val x11 = isz((Val(6) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 6, x11);
  Val x12 = isz((Val(7) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 7, x12);
  Val x13 = isz((Val(8) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 8, x13);
  Val x14 = isz((Val(9) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 9, x14);
  Val x15 = isz((Val(10) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 10, x15);
  Val x16 = isz((Val(11) - x4));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  set(ctx, data0, 11, x16);
  // Reg(<preamble>:4)
