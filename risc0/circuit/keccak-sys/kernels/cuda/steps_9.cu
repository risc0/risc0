...
__device__ RoundToArrayStruct exec_RoundToArray(ExecContext& ctx,
  ...
  RoundToArrayStruct x43 = RoundToArrayStruct{
      ._super = RoundToArray_Super_SuperStruct64Array{
          ...
          x15,
          RoundToArray_Super_SuperStruct{._super = (x21 + x2._super[23]._super)},
          x15,
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x25 + x2._super[21]._super)},
          x15,
          x15,
          x15,
          x15,
          ...
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x31 + x2._super[23]._super)},
          x15,
          x15,
          x15,
          x15,
          ...
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x42 + x2._super[23]._super)}}};
  return x43;
}
