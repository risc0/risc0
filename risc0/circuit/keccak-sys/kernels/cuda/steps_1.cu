...
__device__ void step_Top_32(ExecContext& ctx, MutableBuf arg0) {
  ...
  Val x2425 = ((get(ctx, arg0, 937, 0) + get(ctx, arg0, 941, 0)) + get(ctx, arg0, 942, 0));
  Val x2426 =
      (((x2425 + get(ctx, arg0, 943, 0)) + get(ctx, arg0, 944, 0)) + get(ctx, arg0, 947, 0));
  Val x2427 =
      (((x2426 + get(ctx, arg0, 949, 0)) + get(ctx, arg0, 950, 0)) + get(ctx, arg0, 951, 0));
  Val x2428 =
      (((x2427 + get(ctx, arg0, 952, 0)) + get(ctx, arg0, 957, 0)) + get(ctx, arg0, 959, 0));
  Val x2429 = (get(ctx, arg0, 938, 0) + get(ctx, arg0, 939, 0));
  Val x2430 = (x2429 + get(ctx, arg0, 941, 0));
  Val x2431 =
      (((x2430 + get(ctx, arg0, 945, 0)) + get(ctx, arg0, 948, 0)) + get(ctx, arg0, 949, 0));
  Val x2432 =
      (((x2431 + get(ctx, arg0, 950, 0)) + get(ctx, arg0, 952, 0)) + get(ctx, arg0, 953, 0));
  Val x2433 = ((x2432 + get(ctx, arg0, 955, 0)) + get(ctx, arg0, 956, 0));
  Val x2434 = ((get(ctx, arg0, 939, 0) + get(ctx, arg0, 941, 0)) + get(ctx, arg0, 944, 0));
  Val x2435 =
      (((x2434 + get(ctx, arg0, 945, 0)) + get(ctx, arg0, 946, 0)) + get(ctx, arg0, 947, 0));
  Val x2436 =
      (((x2435 + get(ctx, arg0, 948, 0)) + get(ctx, arg0, 949, 0)) + get(ctx, arg0, 950, 0));
  Val x2437 =
      (((x2436 + get(ctx, arg0, 951, 0)) + get(ctx, arg0, 955, 0)) + get(ctx, arg0, 956, 0));
  Val x2438 = (x2437 + get(ctx, arg0, 960, 0));
  Val x2439 =
      (((x2430 + get(ctx, arg0, 943, 0)) + get(ctx, arg0, 945, 0)) + get(ctx, arg0, 946, 0));
  Val x2440 =
      (((x2439 + get(ctx, arg0, 949, 0)) + get(ctx, arg0, 950, 0)) + get(ctx, arg0, 951, 0));
  Val x2441 =
      (((x2440 + get(ctx, arg0, 954, 0)) + get(ctx, arg0, 957, 0)) + get(ctx, arg0, 958, 0));
  Val x2442 =
      (((x2429 + get(ctx, arg0, 940, 0)) + get(ctx, arg0, 941, 0)) + get(ctx, arg0, 943, 0));
  Val x2443 =
      (((x2442 + get(ctx, arg0, 944, 0)) + get(ctx, arg0, 947, 0)) + get(ctx, arg0, 949, 0));
  Val x2444 =
      (((x2443 + get(ctx, arg0, 951, 0)) + get(ctx, arg0, 952, 0)) + get(ctx, arg0, 953, 0));
  Val x2445 =
      (((x2444 + get(ctx, arg0, 955, 0)) + get(ctx, arg0, 957, 0)) + get(ctx, arg0, 958, 0));
  Val x2446 = (x2445 + get(ctx, arg0, 960, 0));
  Val x2447 = ((get(ctx, arg0, 940, 0) + get(ctx, arg0, 942, 0)) + get(ctx, arg0, 943, 0));
  Val x2448 =
      (((x2447 + get(ctx, arg0, 947, 0)) + get(ctx, arg0, 948, 0)) + get(ctx, arg0, 949, 0));
  Val x2449 =
      (((x2448 + get(ctx, arg0, 956, 0)) + get(ctx, arg0, 957, 0)) + get(ctx, arg0, 959, 0));
  Val x2450 = (x2449 + get(ctx, arg0, 960, 0));
  // BitXor(zirgen/circuit/keccak2/bits.zir:32)
  // Iota(zirgen/circuit/keccak2/keccak.zir:125)
  Val x2451 = ((x2428 + x3) - ((x2428 * Val(2)) * x3));
  Val x2452 = ((x2433 + x6) - ((x2433 * Val(2)) * x6));
  Val x2453 = ((x2438 + x12) - ((x2438 * Val(2)) * x12));
  Val x2454 = ((x2441 + x24) - ((x2441 * Val(2)) * x24));
  Val x2455 = ((x2446 + x48) - ((x2446 * Val(2)) * x48));
  Val x2456 = ((x2450 + x96) - ((x2450 * Val(2)) * x96));
  // Reg(<preamble>:4)
  // TopState(zirgen/circuit/keccak2/top.zir:36)
  set(ctx, arg0, 16, x2451);
  set(ctx, arg0, 17, x2452);
  set(ctx, arg0, 18, x9);
  set(ctx, arg0, 19, x2453);
  set(ctx, arg0, 20, x15);
  set(ctx, arg0, 21, x18);
  set(ctx, arg0, 22, x21);
  set(ctx, arg0, 23, x2454);
  set(ctx, arg0, 24, x27);
  set(ctx, arg0, 25, x30);
  set(ctx, arg0, 26, x33);
  set(ctx, arg0, 27, x36);
