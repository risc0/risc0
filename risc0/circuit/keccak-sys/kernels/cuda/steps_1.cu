...
__device__ void step_Top_0(ExecContext& ctx, MutableBuf arg0) {
  ...
  // Top(zirgen/circuit/keccak/top.zir:481)
...
__device__ void step_Top_16(ExecContext& ctx, MutableBuf arg0) {
  // builtin Sub
  // ShaNextRound(zirgen/circuit/keccak/top.zir:419)
  ...
  if (to_size_t(x2)) {
    // ShaNextRound(zirgen/circuit/keccak/top.zir:420)
...
__device__ void step_Top_32(ExecContext& ctx, MutableBuf arg0) {
  ...
  // Top(zirgen/circuit/keccak/top.zir:499)
  ...
  Val x2405 = get(ctx, arg0, 941, 0);
  // builtin Isz
  Val x2406 = isz((Val(3) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 942, x2406);
  Val x2407 = get(ctx, arg0, 942, 0);
  // builtin Isz
  Val x2408 = isz((Val(4) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 943, x2408);
  Val x2409 = get(ctx, arg0, 943, 0);
  // builtin Isz
  Val x2410 = isz((Val(5) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 944, x2410);
  Val x2411 = get(ctx, arg0, 944, 0);
  // builtin Isz
  Val x2412 = isz((Val(6) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 945, x2412);
  Val x2413 = get(ctx, arg0, 945, 0);
  // builtin Isz
  Val x2414 = isz((Val(7) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 946, x2414);
  Val x2415 = get(ctx, arg0, 946, 0);
  // builtin Isz
  Val x2416 = isz((Val(8) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 947, x2416);
  Val x2417 = get(ctx, arg0, 947, 0);
  // builtin Isz
  Val x2418 = isz((Val(9) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 948, x2418);
  Val x2419 = get(ctx, arg0, 948, 0);
  // builtin Isz
  Val x2420 = isz((Val(10) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 949, x2420);
  Val x2421 = get(ctx, arg0, 949, 0);
  // builtin Isz
  Val x2422 = isz((Val(11) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 950, x2422);
  Val x2423 = get(ctx, arg0, 950, 0);
  // builtin Isz
  Val x2424 = isz((Val(12) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 951, x2424);
  Val x2425 = get(ctx, arg0, 951, 0);
  // builtin Isz
  Val x2426 = isz((Val(13) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 952, x2426);
  Val x2427 = get(ctx, arg0, 952, 0);
  // builtin Isz
  Val x2428 = isz((Val(14) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 953, x2428);
  Val x2429 = get(ctx, arg0, 953, 0);
  // builtin Isz
  Val x2430 = isz((Val(15) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 954, x2430);
  Val x2431 = get(ctx, arg0, 954, 0);
  // builtin Isz
  Val x2432 = isz((Val(16) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 955, x2432);
  Val x2433 = get(ctx, arg0, 955, 0);
  // builtin Isz
  Val x2434 = isz((Val(17) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 956, x2434);
  // builtin Isz
  Val x2435 = isz((Val(18) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 957, x2435);
  Val x2436 = get(ctx, arg0, 957, 0);
  // builtin Isz
  Val x2437 = isz((Val(19) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 958, x2437);
  Val x2438 = get(ctx, arg0, 958, 0);
  // builtin Isz
  Val x2439 = isz((Val(20) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 959, x2439);
  Val x2440 = get(ctx, arg0, 959, 0);
  // builtin Isz
  Val x2441 = isz((Val(21) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 960, x2441);
  Val x2442 = get(ctx, arg0, 960, 0);
  // builtin Isz
  Val x2443 = isz((Val(22) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 961, x2443);
  Val x2444 = get(ctx, arg0, 961, 0);
  // builtin Isz
  Val x2445 = isz((Val(23) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 962, x2445);
  Val x2446 = get(ctx, arg0, 962, 0);
  // builtin Add
  // RoundToArray(zirgen/circuit/keccak/keccak.zir:116)
  Val x2447 = ((get(ctx, arg0, 939, 0) + x2409) + x2411);
  Val x2448 = (((x2447 + x2413) + x2415) + x2421);
  Val x2449 = (((x2448 + x2425) + x2427) + x2429);
  Val x2450 = (((x2449 + x2431) + x2440) + x2444);
  Val x2451 = (get(ctx, arg0, 940, 0) + x2405);
  ...
  Val x2462 = (((x2461 + get(ctx, arg0, 956, 0)) + x2440) + x2442);
...
__device__ void step_Top_48(ExecContext& ctx, MutableBuf arg0) {
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  // OneHot(zirgen/circuit/keccak/one_hot.zir:7)
  ...
  Val x3 = ((get(ctx, arg0, 830, 1) * x1) + (get(ctx, arg0, 862, 1) * x2));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  // OneHot(zirgen/circuit/keccak/one_hot.zir:7)
  // LoadWin(zirgen/circuit/keccak/top.zir:165)
  ...
  // ShaCycle(zirgen/circuit/keccak/top.zir:192)
  Val x6 = ((get(ctx, arg0, 846, 1) * x1) + (get(ctx, arg0, 878, 1) * x2));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  // OneHot(zirgen/circuit/keccak/one_hot.zir:7)
  // ShaCycle(zirgen/circuit/keccak/top.zir:189)
  ...
  // ShaCycle(zirgen/circuit/keccak/top.zir:192)
  Val x8 =
      (((x3 + (get(ctx, arg0, 894, 1) * x4)) * x5) + ((x6 + (get(ctx, arg0, 910, 1) * x4)) * x7));
  // LoadWin(zirgen/circuit/keccak/top.zir:168)
  Val x9 = ((get(ctx, arg0, 831, 1) * x1) + (get(ctx, arg0, 863, 1) * x2));
  // LoadWin(zirgen/circuit/keccak/top.zir:175)
  Val x10 = ((get(ctx, arg0, 847, 1) * x1) + (get(ctx, arg0, 879, 1) * x2));
  // LoadWin(zirgen/circuit/keccak/top.zir:167)
  Val x11 =
      (((x9 + (get(ctx, arg0, 895, 1) * x4)) * x5) + ((x10 + (get(ctx, arg0, 911, 1) * x4)) * x7));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  ...
  set(ctx, arg0, 752, (bitAnd(x11, Val(256)) * Val(2005401601)));
  set(ctx, arg0, 753, (bitAnd(x11, Val(512)) * Val(2009333761)));
  set(ctx, arg0, 754, (bitAnd(x11, Val(1024)) * Val(2011299841)));
  set(ctx, arg0, 755, (bitAnd(x11, Val(2048)) * Val(2012282881)));
  set(ctx, arg0, 756, (bitAnd(x11, Val(4096)) * Val(2012774401)));
  set(ctx, arg0, 757, (bitAnd(x11, Val(8192)) * Val(2013020161)));
  set(ctx, arg0, 758, (bitAnd(x11, Val(16384)) * Val(2013143041)));
  set(ctx, arg0, 759, (bitAnd(x11, Val(32768)) * Val(2013204481)));
  set(ctx, arg0, 760, bitAnd(x11, Val(1)));
  set(ctx, arg0, 761, (bitAnd(x11, Val(2)) * Val(1006632961)));
  set(ctx, arg0, 762, (bitAnd(x11, Val(4)) * Val(1509949441)));
  set(ctx, arg0, 763, (bitAnd(x11, Val(8)) * Val(1761607681)));
  set(ctx, arg0, 764, (bitAnd(x11, Val(16)) * Val(1887436801)));
  set(ctx, arg0, 765, (bitAnd(x11, Val(32)) * Val(1950351361)));
  set(ctx, arg0, 766, (bitAnd(x11, Val(64)) * Val(1981808641)));
  set(ctx, arg0, 767, (bitAnd(x11, Val(128)) * Val(1997537281)));
  set(ctx, arg0, 768, (bitAnd(x8, Val(256)) * Val(2005401601)));
  set(ctx, arg0, 769, (bitAnd(x8, Val(512)) * Val(2009333761)));
  set(ctx, arg0, 770, (bitAnd(x8, Val(1024)) * Val(2011299841)));
  set(ctx, arg0, 771, (bitAnd(x8, Val(2048)) * Val(2012282881)));
  set(ctx, arg0, 772, (bitAnd(x8, Val(4096)) * Val(2012774401)));
  set(ctx, arg0, 773, (bitAnd(x8, Val(8192)) * Val(2013020161)));
  set(ctx, arg0, 774, (bitAnd(x8, Val(16384)) * Val(2013143041)));
  set(ctx, arg0, 775, (bitAnd(x8, Val(32768)) * Val(2013204481)));
  set(ctx, arg0, 776, bitAnd(x8, Val(1)));
  set(ctx, arg0, 777, (bitAnd(x8, Val(2)) * Val(1006632961)));
  set(ctx, arg0, 778, (bitAnd(x8, Val(4)) * Val(1509949441)));
  set(ctx, arg0, 779, (bitAnd(x8, Val(8)) * Val(1761607681)));
  set(ctx, arg0, 780, (bitAnd(x8, Val(16)) * Val(1887436801)));
  set(ctx, arg0, 781, (bitAnd(x8, Val(32)) * Val(1950351361)));
  set(ctx, arg0, 782, (bitAnd(x8, Val(64)) * Val(1981808641)));
  set(ctx, arg0, 783, (bitAnd(x8, Val(128)) * Val(1997537281)));
  return;
}
