...
__device__ void step_Top_12(ExecContext& ctx, MutableBuf arg0) {
  ...
  // KeccackNextRound(zirgen/circuit/keccak2/top.zir:413)
...
__device__ void step_Top_44(ExecContext& ctx, MutableBuf arg0) {
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  ...
  // ShaCycle(zirgen/circuit/keccak2/top.zir:191)
  Val x8 =
      (((x3 + (get(ctx, arg0, 890, 1) * x4)) * x5) + ((x6 + (get(ctx, arg0, 906, 1) * x4)) * x7));
  // LoadWin(zirgen/circuit/keccak2/top.zir:167)
  ...
  // LoadWin(zirgen/circuit/keccak2/top.zir:166)
  Val x11 =
      (((x9 + (get(ctx, arg0, 891, 1) * x4)) * x5) + ((x10 + (get(ctx, arg0, 907, 1) * x4)) * x7));
  // NondetBitReg(zirgen/circuit/keccak2/bits.zir:11)
  ...
  set(ctx, arg0, 691, (bitAnd(x11, Val(2048)) * Val(2012282881)));
  set(ctx, arg0, 692, (bitAnd(x11, Val(4096)) * Val(2012774401)));
  set(ctx, arg0, 693, (bitAnd(x11, Val(8192)) * Val(2013020161)));
  set(ctx, arg0, 694, (bitAnd(x11, Val(16384)) * Val(2013143041)));
  set(ctx, arg0, 695, (bitAnd(x11, Val(32768)) * Val(2013204481)));
  set(ctx, arg0, 696, bitAnd(x11, Val(1)));
  set(ctx, arg0, 697, (bitAnd(x11, Val(2)) * Val(1006632961)));
  set(ctx, arg0, 698, (bitAnd(x11, Val(4)) * Val(1509949441)));
  set(ctx, arg0, 699, (bitAnd(x11, Val(8)) * Val(1761607681)));
  set(ctx, arg0, 700, (bitAnd(x11, Val(16)) * Val(1887436801)));
  set(ctx, arg0, 701, (bitAnd(x11, Val(32)) * Val(1950351361)));
  set(ctx, arg0, 702, (bitAnd(x11, Val(64)) * Val(1981808641)));
  set(ctx, arg0, 703, (bitAnd(x11, Val(128)) * Val(1997537281)));
  set(ctx, arg0, 704, (bitAnd(x8, Val(256)) * Val(2005401601)));
  set(ctx, arg0, 705, (bitAnd(x8, Val(512)) * Val(2009333761)));
  set(ctx, arg0, 706, (bitAnd(x8, Val(1024)) * Val(2011299841)));
  set(ctx, arg0, 707, (bitAnd(x8, Val(2048)) * Val(2012282881)));
  set(ctx, arg0, 708, (bitAnd(x8, Val(4096)) * Val(2012774401)));
  set(ctx, arg0, 709, (bitAnd(x8, Val(8192)) * Val(2013020161)));
  set(ctx, arg0, 710, (bitAnd(x8, Val(16384)) * Val(2013143041)));
  set(ctx, arg0, 711, (bitAnd(x8, Val(32768)) * Val(2013204481)));
  set(ctx, arg0, 712, bitAnd(x8, Val(1)));
  set(ctx, arg0, 713, (bitAnd(x8, Val(2)) * Val(1006632961)));
  set(ctx, arg0, 714, (bitAnd(x8, Val(4)) * Val(1509949441)));
  set(ctx, arg0, 715, (bitAnd(x8, Val(8)) * Val(1761607681)));
  set(ctx, arg0, 716, (bitAnd(x8, Val(16)) * Val(1887436801)));
  set(ctx, arg0, 717, (bitAnd(x8, Val(32)) * Val(1950351361)));
  set(ctx, arg0, 718, (bitAnd(x8, Val(64)) * Val(1981808641)));
  set(ctx, arg0, 719, (bitAnd(x8, Val(128)) * Val(1997537281)));
  return;
}
