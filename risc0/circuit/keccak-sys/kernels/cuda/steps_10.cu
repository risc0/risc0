...
__device__ RoundToArrayStruct exec_RoundToArray(ExecContext& ctx,
  ...
  RoundToArray_Super_SuperStruct x15 = RoundToArray_Super_SuperStruct{._super = Val(0)};
  // RoundToArray(zirgen/circuit/keccak2/keccak.zir:116)
  ...
  RoundToArrayStruct x43 = RoundToArrayStruct{
      ._super = RoundToArray_Super_SuperStruct64Array{
          RoundToArray_Super_SuperStruct{._super = x8},
          RoundToArray_Super_SuperStruct{._super = x14},
          x15,
          RoundToArray_Super_SuperStruct{._super = (x21 + x2._super[23]._super._super)},
          x15,
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x25 + x2._super[21]._super._super)},
          x15,
          x15,
          x15,
          x15,
          ...
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x31 + x2._super[23]._super._super)},
          x15,
          x15,
          x15,
          x15,
          ...
          x15,
          x15,
          RoundToArray_Super_SuperStruct{._super = (x42 + x2._super[23]._super._super)}}};
  return x43;
}
