...
CONSTANT uint32_t FIRMWARE_START_ADDR = 0xf0000000;
...
CONSTANT uint32_t CSR_MCOUNTDOWN = 0x7C7;  // How many cycles until I fire the timer
...
CONSTANT uint32_t MAX_ACCUM_PER_ROW = 156;
