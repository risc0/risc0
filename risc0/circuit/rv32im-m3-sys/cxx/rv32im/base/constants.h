...
CONSTANT uint32_t P2_TMP1_ADDR = 0xffff0280;
CONSTANT uint32_t P2_TMP1_WORD = P2_TMP1_ADDR / 4;
CONSTANT uint32_t P2_TMP2_ADDR = 0xffff02a0;
CONSTANT uint32_t P2_TMP2_WORD = P2_TMP2_ADDR / 4;
