...
CONSTANT uint32_t MODE_MACHINE = 1;
...
CONSTANT uint32_t CSR_BASE_WORD = CSR_BASE_ADDR / 4;
...
#define CSR_ADDR(name) (CSR_BASE_ADDR + 4 * CSR_ ## name)
...
CONSTANT uint32_t MAX_ACCUM_PER_ROW = 136;
