...
import {IRiscZeroVerifier, Output, OutputLib, Receipt as RiscZeroReceipt, ReceiptClaim, ReceiptClaimLib, ExitCode, SystemExitCode} from "../contracts/IRiscZeroVerifier.sol";
...
contract RiscZeroGroth16VerifierTest is Test {
    ...
    RiscZeroReceipt internal TEST_RECEIPT =
        RiscZeroReceipt(
            ...
            ReceiptClaim(
                TEST_IMAGE_ID,
                bytes32(
                    0xc799203f040ca28956c6be56ff8aa97d43250caead998325ba004fcb5a6e7c91
                ),
    ...
    bytes32 internal constant TEST_IMAGE_ID =
        bytes32(
            0x88c105ee779cd8562cda0a2e0eb5d652a640ca0fd47bf8653f0705acf2ea373c
        );
