    ...
    def step_compute_sanitizer(self):
        self.pipeline.add_step(
            bk.GroupStep(
                ...
                steps=[
                    bk.CommandStep(
                        command="echo compute-sanitizer",
                    ),
                ],
            )
        )
